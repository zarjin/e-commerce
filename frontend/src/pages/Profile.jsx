        ...
        <div className='space-y-6'>
          ...
          <div className='space-y-4'>
            <div className='flex items-center space-x-3 p-3 hover:bg-green-50 rounded-lg transition-colors'>
              <span className='text-green-600 font-medium min-w-[80px]'>Name:</span>
              <span className='text-gray-700'>
                {authUserData.firstName} {authUserData.lastName}
              </span>
            </div>
            <div className='flex items-center space-x-3 p-3 hover:bg-green-50 rounded-lg transition-colors'>
              <span className='text-green-600 font-medium min-w-[80px]'>Email:</span>
              <span className='text-gray-700'>{authUserData.email}</span>
            </div>
            <div className='flex items-center space-x-3 p-3 hover:bg-green-50 rounded-lg transition-colors'>
              <span className='text-green-600 font-medium min-w-[80px]'>Phone:</span>
              <span className='text-gray-700'>{authUserData.phone || 'Not Provided'}</span>
            </div>
          </div>
          <Link to='/update-user'>
